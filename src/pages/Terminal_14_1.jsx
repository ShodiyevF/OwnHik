export default function Terminal_14_1() {
	return (
		<div>
			<div className="home_div">
				<div className="home_div2">
					<div className="button_div">
						<a
							href={
								"http://ftp.hikvision.ru/01.%20Firmware/01.%20Hikvision/06.%20Access%20Control/4.%20Terminal/DS-K1T605/V1.2.0_build181114/ARM/ACS_605_EN_GM_V1.2.0_build181114.zip"
							}
							className="button_div2"
						>
							<h5>ARM/ ACS_605_EN_GM_V1.2.0_build181114.zip </h5>
						</a>
						<a
							href={
							...
							className="button_div2"
						>
							<h5>MCU/ ACS_DS-K1T60X_GM_STD_1.0.0_180612_Net.bin </h5>
						</a>
						<a
							href={
							...
							className="button_div2"
						>
							<h5>MCU/ ACS_DS-K1T60X_GM_STD_1.0.0_180612_Serial.bin </h5>
						</a>
						<a
							href={
						...
						>
							<h5>
								K1T605 Series Terminal V1.2.0_build181114 Release Note.docx
							</h5>
						</a>
					</div>
				</div>
